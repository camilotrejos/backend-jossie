...
router.post("/", async (req,res) => {
    ...
    const { id_barbero, nombre_barbero, id_servicio_barbero } = req.body;
    const barb = new Barberos({id_barbero, nombre_barbero, id_servicio_barbero});
    await barb.save();
...
router.put("/:id_barbero", async (req,res) => {
    ...
    const { id_barbero, nombre_barbero, id_servicio_barbero } = req.body;
    const newBarb = { id_barbero, nombre_barbero, id_servicio_barbero };
